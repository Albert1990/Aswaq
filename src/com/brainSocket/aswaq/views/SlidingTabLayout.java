...
package com.brainSocket.aswaq.views;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private OnTabItemClick listenerOnTabItemClick;
    ...
    public void setOnTabItemClickListener(OnTabItemClick listenerOnTabItemClick) {
        this.listenerOnTabItemClick = listenerOnTabItemClick;
    }
        ...
        public void onClick(View v) {
            ...
            for (int i = 0; i < mTabStrip.getChildCount(); i++) {
                if (v == mTabStrip.getChildAt(i)) {
                    if(listenerOnTabItemClick == null || listenerOnTabItemClick.onTabItemClick(i))
    ...
    public interface OnTabItemClick {
        boolean onTabItemClick(int tabIndex);
    }
